...
const TAG_STYLES = {
  "Diagnostic Radiology": "bg-blue-50 text-blue-700 ring-blue-200",
  "Interventional Radiology": "bg-rose-50 text-rose-700 ring-rose-200",
  Neuroradiology: "bg-indigo-50 text-indigo-700 ring-indigo-200",
  "Musculoskeletal Radiology": "bg-orange-50 text-orange-700 ring-orange-200",
  "Pediatric Radiology": "bg-emerald-50 text-emerald-700 ring-emerald-200",
  "Nuclear Medicine": "bg-slate-100 text-slate-700 ring-slate-300",
};
...
const HOSPITALS = [
  "Ashoka Imaging Institute",
  "Sunrise Radiology Center",
  "St. Luke's Medical",
  "Metro Radiology Group",
  "Orchid Diagnostic Hospital",
  "Pinewood Imaging Clinic",
...
const DOCTORS = Array.from({ length: 17 }, (_, i) => {
  const rand = seededRandom(i * 103 + 47);
...
function Initials({ name }) {
  ...
  return (
    <div className="flex h-14 w-14 flex-none items-center justify-center rounded-full bg-gradient-to-br from-slate-800 to-slate-950 text-base font-semibold text-white ring-4 ring-blue-100">
...
function DoctorCard({ doc }) {
  return (
    <div className="group flex flex-col rounded-2xl border border-slate-200 bg-white p-5 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md">
      ...
      <BookingButton doctor={{ ...doc, specialty: "Radiologist", fee: "₹1,600" }} className="mt-4 w-full rounded-xl bg-slate-900 py-2.5 text-sm font-semibold text-white transition group-hover:bg-blue-600">Book appointment</BookingButton>
    </div>
  );
}
...
export default function RadiologyDoctors() {
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mb-8 flex flex-col gap-1">
          ...
          <h1 className="text-3xl font-bold text-slate-900">
            Find a radiology specialist
          </h1>
          <p className="max-w-xl text-slate-500">
            17 radiologists across diagnostic and interventional radiology,
            neuroradiology, musculoskeletal imaging, pediatric radiology, and
            nuclear medicine.
          </p>
        </div>
        ...
        <div className="mb-8 flex flex-col gap-3 sm:flex-row sm:items-center">
          <input
            ...
            className="w-full rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-sm text-slate-700 shadow-sm outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-100 sm:max-w-xs"
          />
