...
const TAG_STYLES = {
  "Medical Oncology": "bg-violet-50 text-violet-700 ring-violet-200",
  "Surgical Oncology": "bg-rose-50 text-rose-700 ring-rose-200",
  "Radiation Oncology": "bg-amber-50 text-amber-700 ring-amber-200",
  "Hematology-Oncology": "bg-teal-50 text-teal-700 ring-teal-200",
  "Pediatric Oncology": "bg-slate-100 text-slate-700 ring-slate-300",
};
...
const HOSPITALS = [
  "Ashoka Cancer Institute",
  "Sunrise Oncology Center",
  "St. Luke's Medical",
  "Metro Oncology Group",
  "Orchid Cancer Care Hospital",
  "Pinewood Oncology Clinic",
...
const DOCTORS = Array.from({ length: 9 }, (_, i) => {
  const rand = seededRandom(i * 97 + 41);
...
function Initials({ name }) {
  ...
  return (
    <div className="flex h-14 w-14 flex-none items-center justify-center rounded-full bg-gradient-to-br from-slate-800 to-slate-950 text-base font-semibold text-white ring-4 ring-violet-100">
...
function PulseDivider() {
  return (
    <svg
      viewBox="0 0 200 24"
      className="h-5 w-full text-violet-300"
...
export default function OncologyDoctors() {
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#e1f5f0] to-[#c7e9e1] px-6 py-10">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mb-8 flex flex-col gap-1">
          <span className="text-sm font-semibold uppercase tracking-wide text-violet-600">
            Oncology directory
          </span>
          ...
          <p className="max-w-xl text-slate-500">
            9 oncologists across medical, surgical, and radiation oncology,
            hematology-oncology, and pediatric oncology.
          </p>
        </div>
        ...
        <div className="mb-8 flex flex-col gap-3 sm:flex-row sm:items-center">
          <input
            ...
            className="w-full rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-sm text-slate-700 shadow-sm outline-none focus:border-violet-400 focus:ring-2 focus:ring-violet-100 sm:max-w-xs"
          />
